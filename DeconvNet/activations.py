...
def get_activations(layer_num, base_model, mode='summation', folder='/home/Irving/Data/validation'):
    """
...
def find_strongest_image(layer_num, top=9, folder='/home/Irving/Data/validation'):
    """
...
def get_strongest_filter(img_id, layer):
    ...
    # Make sure that dimensions 2 and 3 are spacial (Image is square)
    assert activation_img.shape[2] == activation_img.shape[3], "Index ordering incorrect"     # If[2]!=[3],output "Index ordering #incorrect                                                                                      (1, 256, 13, 13)
    ...
    # Remove batch size dimension
    assert activation_img.shape[0] == 1
    activation_img = activation_img.sum(0)                 ##combine
